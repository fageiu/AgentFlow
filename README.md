...
- Evaluation Workbench：内置 12 条评测用例，支持按能力分组运行、断言诊断、工具轨迹、token/工具调用指标和模型/Prompt 对比信息。
...
- Week 13：对齐原规划补齐评测指标，内置 12 条 golden task，展示平均耗时、平均工具调用、token 消耗、失败原因和模型/Prompt 配置。
